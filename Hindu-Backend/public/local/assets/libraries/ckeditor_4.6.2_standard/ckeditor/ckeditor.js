...
*/
      ...
      proto: {
        ...
        show: function (a, b, d, m) {
          ...
          if (!e) {
            ...
            c["rtl" == k.lang.dir ? 37 : 39] = CKEDITOR.env.ie
              ? "mouseup"
              : "click";
        ...
        render: function (a, b, d) {
          ...
          this.command &&
            ...
            (f = e.getCommandKeystroke(f)) &&
              (c = CKEDITOR.tools.keystrokeToString(
                e.lang.common.keyboard,
                f
              )));
          a = {
            id: h,
        ...
        for (var c = a.data.definition, d, b = 0; b < c.contents.length; ++b)
          if ((d = c.contents[b]))
            l(a.editor, a.data.name, c, d.elements),
              d.hidden &&
                d.filebrowser &&
                (d.hidden = !h(c, d.id, d.filebrowser));
    });
  })();
  (function () {
    function k(a) {
  ...
  (function () {
    ...
    CKEDITOR.env.gecko &&
      (d += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;"');
    var d =
        d +
      ...
      proto: {
        ...
        render: function (a, b) {
          ...
          d = {
            ...
            cls: this.className || "",
            titleJs:
              d.gecko && !d.hc ? "" : (this.title || "").replace("'", ""),
            keydownFn: m,
            focusFn: n,
            clickFn: e,
          };
    ...
    menuGenerator: function (a, c) {
      ...
      h
        ...
        : k &&
          ...
          b.grayt_problemdescription &&
            k &&
            (b.grayt_problemdescription.label = k),
      ...
      for (var l in b)
        (h &&
          ...
          ((e[l] =
            "undefined" != typeof b[l].state
              ? b[l].state
              : CKEDITOR.TRISTATE_OFF),
          "function" !== typeof b[l].verification ||
            b[l].verification(a) ||
            delete e[l],
        ...
        c.ui.addRichCombo("Styles", {
          ...
          init: function () {
            ...
            for (f = k.length; e < f; e++)
              (b = k[e]),
                ...
                (d = b._.type),
                d != c &&
                  (this.startGroup(g["panelTitle" + String(d)]), (c = d)),
                this.add(
                  a,
          ...
          onOpen: function () {
            ...
            for (var h in f) {
              var d = f[h],
                e = d._.type;
              d.checkApplicable(b, c, c.activeFilter)
                ? a[e]++
                : this.hideItem(h);
  ...
  CKEDITOR.plugins.add("table", {
    ...
    init: function (a) {
      ...
      if (!a.blockless) {
        ...
        a.addCommand(
          "tableProperties",
          new CKEDITOR.dialogCommand("tableProperties", e())
        );
        a.addCommand(
          "tableDelete",
          e({
  ...
  (function () {
    function t(e) {
      function d(a) {
        0 < b.length ||
          ...
          (CKEDITOR.dom.element.setMarker(c, a, "selected_cell", !0),
          b.push(a));
      }
      e = e.getRanges();
      for (var b = [], c = {}, a = 0; a < e.length; a++) {
        ...
        if (f.collapsed)
          (f = f.getCommonAncestor()),
            (f = f.getAscendant("td", !0) || f.getAscendant("th", !0)) &&
              b.push(f);
        else {
    ...
    function v(e, d) {
      for (var b = d ? Infinity : 0, c = 0; c < e.length; c++) {
        ...
        a = e[c];
        for (
          var f = d, g = a.getParent().$.cells, h = 0, k = 0;
          k < g.length;
          k++
        ) {
          var l = g[k],
      ...
      if (e instanceof CKEDITOR.dom.selection) {
        ...
        a: {
          ...
          (g = g.getPrevious())
            ? (b = g.getLast())
            : ((g = e[b].getParent()),
              (b = (g = g.getNext()) ? g.getChild(0) : null));
        }
        ...
        e instanceof CKEDITOR.dom.element &&
          ((d = e.getParent()),
          1 == d.getChildCount() ? d.remove() : e.remove());
    }
    function q(e, d) {
      var b = e.getDocument(),
        c = CKEDITOR.document;
    ...
    function w(e, d, b) {
      ...
      if (d) {
        ...
        if (!r || e.$ == r) return !1;
        c["up" == d || "left" == d ? "unshift" : "push"](
          new CKEDITOR.dom.element(r)
        );
      }
      d = e.getDocument();
      var p = l,
