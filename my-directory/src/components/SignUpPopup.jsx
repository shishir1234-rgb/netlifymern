...
<<<<<<< HEAD
import loadingGif from '../assets/images/truck.gif'; // Import your loading GIF
...
<<<<<<< HEAD
  ...
  const [loginPopup, setLoginPopup] = useState(false); // State to control login popup
...
<<<<<<< HEAD
  ...
  return (
    <>
      ...
      {/* Login Popup */}
      {loginPopup && (
        <LoginPopup onClose={() => setShowLoginPopup(false)} onSuccess={handleLoginSuccess} />
